...
```{r}
install.packages(c('tidyr','dplyr', 'deSolve', 'ggplot2', 'here'))
BiocManager::install(c('Seurat', 'pheatmap'))
...
## 6. Advanced data manipulation (Under Construction!)

### 6.1. Wide vs. long table format

### 6.2. Subsetting

### 6.3 Summarizing the data

------------------------------------------------------------------------

## 7. Key takeaways for this Computational Systems Toxicology Modeling and Informatics (CSTMI) Workshop
