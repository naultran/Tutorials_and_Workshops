...
A link to a shared Google Drive was provided to you via email. These files will be used for the tutorial and may take 1-2 hours to copy due to their size. Ensure you have these files **copied to your own Google Drive**. After doing this, you should have a folder called **SIVBWorkshop_Files**, which should **NOT** be nested within another folder. **The SIVBWorkshop_Files folder should be visible when you click _My Drive_**.
...
![Download Instructions](images/download_instructions.png){: width="500px" }
...
![Run Section](images/Colab_runChunk.png){: width="500px" }
...
![Successful Connection](images/successful_connection.png){: width="500px" }
